...
Entre de dispositivos que realizan la clasificacion de paquetes se encuentran soluciones implementadas de manera completa en hardware, FPGA, ASIC u otra plataforma, o implementadas, procesador de proposito general mediande, completamente en software. La intencion de de este proyecto integrador, como puede verse de manera grafica en la figura~\ref{fig:hwsw}, es complementar las ventajas de ambos mundos maximizandolas y reduciendo asi las desventajas de utilizar el hardware o el software por separado. 

...
Para el problema planteado en el capitulo anterior, se propone, de manera procedimental, la siguiente solucion: 
...
Para implementar la soluccion propuesta se propone la utilizacion de la arquitectura de la figura~\ref{fig:solucion}
 \begin{figure}[h]
  \centering
...
Este módulo tiene como función acceder a los campos que conforman la cabecera IP en los paquetes entrantes. La información recolectada es enviada al micrprocesador para que éste lleve a cabo el software de clasificación.

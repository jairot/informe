...
La cache desarrollada para este proyecto esta pensada a los fines de satisfacer la posibilidad de que varios paquetes consecutivos tengan una direccion de IP destino. Con la implementacion utilizada se logro un tiempo de acceso uniforme de alrededor de 1000 ciclos por segundo. En el grafico ~\ref{fig:cachecomp} se puede ver como el peor caso del algoritmo LLU soporta hasta 10000 paquetes por segundo sin cache y hasta 700000 paquetes por segundo con la cache. Aunque este ejemplo solo analiza el caso en el que son todos Hits, es posible ver la mejora sustancial que implica una cache. 

...
\subsubsection{Evolución en los dispositivos de enrutamiento}
...
\subsubsection{Lógica reconfigurable como respuesta}
...
Considerando los problemas planteados, el objetivo general de este proyecto es estudiar las diversas arquitecturas de clasificacion de paquetes para poder encontrar las limitaciones en la implementacion de las mismas tanto en software como en hardware. 

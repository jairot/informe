...
Estudiar como se realiza la clasificacion de paquetes y encontrar las limitaciones en la implentacion tanto en software como en hardware
Implementar la calsificacion de paquetes

...
Propósito  & 1) sarasasa
2)sasas
\\ \hline
 Prerequisitos  & Indica la disponibilidad de los resultados de la clasificación\\ \hline
 Datos de Prueba & Señala la presencia de datos en en la FIFO\\ \hline
 Pasos & Salida conectada a la ultima posicion del registro de desplazamiento\\ \hline
 Resultados Esperados & Bus interno por el que puede viajar las 5 palabras de la cabecera en un solo ciclo\\ \hline
 Evaluación de la Prueba  & Indica la disponibilidad de la cabecera en oheader \\ \hline
	\end{tabular}

...
\rowcolor[gray]{0.9} o\_data & N/A & Salida conectada a la ultima posicion del registro de desplazamiento\\ \hline
...
A continuacion se muestran las señales que componen el modulo con su correspondiente descripcion.

\begin{figure}[H]
  \centering
	\includegraphics[scale=0.60]{3-arquitectura/graf/bloquplink.eps}
  \caption{Uplink}

...
\begin{frame}{LLU}
\begin{block}<+->{LLU - Búsqueda}
	\center	
	\includegraphics[scale=0.30]{figures/llusearch.eps}  
\end{block}
...
\begin{itemize}
      \scriptsize
     	\item La cache desarrollada busca explotar la posibilidad de que varios paquetes consecutivos tengan una dirección IP destino que pertenezcan a un grupo común de flujos (flow locality).

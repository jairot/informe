...
\begin{frame}
  \includegraphics[scale=0.45]{figures/MPLS_packet.eps} 
  
  \includegraphics[scale=0.4]{figures/vlan.eps}
\end{frame}
...
\begin{frame}{FPGA como plataforma para SoC}
  ...
  \begin{block}<2->{FPGA como plataforma para SoC} 
	...
	\center
        \includegraphics<2->[scale=0.35]{figures/soc2.eps} 
...
\begin{block}  
 ...
 \center 
\includegraphics[scale=0.5]{figures/interseccion.eps}
